...
export default function Page() {
  ...
  return (
    <div className="flex justify-center w-full bg-gray-100 min-h-screen">
      <div className="flex flex-col h-[calc(100vh-2rem)] w-full max-w-[1024px] min-h-[600px] my-4 p-4 bg-gray-50 rounded-xl shadow-md">
        ...
        <div className="flex-1 min-h-[400px] overflow-y-auto space-y-4 mb-4 p-4 bg-white rounded-lg shadow-sm">
          ...
          {messages.map((message) => {
            // Check if this message contains product results
            const hasProducts = message.toolInvocations?.some(
              (tool) =>
                tool.toolName === "searchForProducts" && tool.state === "result"
            );
              ...
              >
                ...
                >
                  ...
                  <div className="text-sm whitespace-normal">
                    ...
                    <div className={hasProducts ? "w-full" : ""}>
